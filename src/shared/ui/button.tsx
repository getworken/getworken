 ...
 * Part of the shared UI layer (shadcn/ui integration).
 *
 * Built on Radix UI Slot primitive for polymorphic rendering.
 *
 * @param variant - Visual style: default | destructive | outline | secondary | ghost | link
 * @param size - Button size: default | sm | lg | icon
 * @param asChild - If true, merges props with child component
