/**
 * Employee Job History Modal Component
 * @module shared/ui/modals/EmployeeJobHistoryModal
 * 
 * Modal dialog displaying employee's job completion history.
 * Shows past assignments, dates, and performance metrics.
 * 
